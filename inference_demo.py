...
def run_inference_episode(agent: PPOAgent, env: TrafficIntersectionEnv, max_steps: int = 100):
    ...
    print("
🚦 Starting inference episode..."    print(f"Initial phase: {current_phase.name}")
    ...
    print("
🏁 Episode completed!"    print(f"Total steps: {len(episode_data['actions'])}")
...
def analyze_decisions(episode_data: dict):
    ...
    print("
📊 Decision Analysis:"    print(f"  - Total actions taken: {len(actions)}")
...
def main():
    ...
    print("
✅ Inference demo completed!"    print(f"💡 The trained PPO agent successfully controlled traffic signals,")
